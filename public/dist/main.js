...
var AliasMapper = function (_Controller) {
    _inherits(AliasMapper, _Controller);

    function AliasMapper() {
        _classCallCheck(this, AliasMapper);

        return _possibleConstructorReturn(this, (AliasMapper.__proto__ || Object.getPrototypeOf(AliasMapper)).apply(this, arguments));
    }

    _createClass(AliasMapper, [{
        key: 'initialize',
        value: function initialize() {
            var _this2 = this;

            this.nameTarget.addEventListener('transitionend', function (e) {
                return _this2.onTransitionEnd(e);
            });
            this.aliasTarget.addEventListener('transitionend', function (e) {
                return _this2.onTransitionEnd(e);
            });
        ...
        value: function onSubmit(e) {
            ...
            var alias = this.pickerTarget.value;

            _axios2.default.get('api/endpoint.php', { params: { alias: alias } }).then(function (res) {
                return _this3.updateName(res.data);
            }).catch(function (err) {
...
var _AliasMapper = __webpack_require__(/*! ./AliasMapper */ "./src/AliasMapper.js");

var _AliasMapper2 = _interopRequireDefault(_AliasMapper);

__webpack_require__(/*! ./app.scss */ "./src/app.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = _stimulus.Application.start();

app.register('AliasMapper', _AliasMapper2.default);
